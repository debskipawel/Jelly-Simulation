...
extern "C"
{
	...
	__declspec(dllexport) void __cdecl MoveOnMiddleClick(float dx, float dy, bool shiftClicked);
	...
	__declspec(dllexport) void __cdecl UpdateVisualizationParameters(bool drawControlPoints, bool drawSteeringCube, bool drawShadedCube, bool drawBoundingCuboid, bool drawDuck);
